          ...
          <div className="border border-border-strong p-6 md:p-8 relative overflow-hidden group hover:border-[#5865F2]/30 transition-colors duration-500">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-[#5865F2]/10 border border-[#5865F2]/20 rounded-full flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Ghost Development</h3>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                <div className="p-3 bg-surface border border-border rounded-sm">
                  ...
                  <span className="text-lg font-semibold block">Aktywny</span>
                  <span className="mono text-[9px] text-muted/40 uppercase tracking-[0.2em]">Serwer</span>
                </div>
              </div>
